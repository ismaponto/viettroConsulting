...
function Paraquien() {
	...
	return (
		<div className="flex  w-full justify-center items-align-center shadow  md:flex-col">
			<h1 className="mb-2 flex flex-col center justify-center w-full text-3xl bg-blue-800 w-100 text-blue-50 text-bold dark:text-white h-36">
				{' '}
			...
			<div className="flex flex-row justify-center  h-72">
				...
				<div className="max-w-sm w-full m-2 ">
					...
					>
Saber mas sobre Consultorias Estrategicas					</motion.button>
				</div>
				<div className="max-w-sm w-full m-2">
					...
					>
Saber mas sobre Asesorias Estrategicas					</motion.button>
				</div>
				<div className="max-w-sm w-full m-2 ">
					...
					>
Saber mas sobre Formaciones					</motion.button>
				</div>
				<div className="max-w-sm w-full m-2">
					...
					>
Saber mas sobre Retiros					</motion.button>
				</div>
			</div>
			<div />{' '}
		</div>
