...
Soy Matias  </h3>
    ...
    <div className="flex flex-row flex-wrap w-full justify-center md:flex-wrap md:flex-col  ">
      ...
      <div className="flex flex-col max-w-xl flex-0 center leading-10 text-xxl text-gray-400 justify-center">
       <p className='h-24'>Como gerente, emprendedor, abogado, máster en políticas públicas y en Administración Pública, he liderado más de 20 proyectos en
         los últimos 5 años. </p>
         <br />
         <p className='h-24'>Mi experiencia y formación teórica y práctica en planificación, gestión estratégica y gestión de proyectos me
          han llevado a desarrollar High Stratégie,
