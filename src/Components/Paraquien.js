...
function Paraquien() {
    return ( < div className = "flex flex-wrap w-full justify-center md:flex-col" >
        ...
        <
        h2 className = "mb-2 flex flex-col center justify-center w-full text-3xl bg-blue-800 w-100 text-blue-50 text-bold dark:text-white h-36" > ¿Es el método High Stratégie para mí ?
        <
        /h2>
