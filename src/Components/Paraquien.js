...
function Paraquien() {
	return (
		<div className="flex flex-wrap w-full justify-center md:flex-col">
			<h2 className="mb-2 flex flex-col center justify-center w-full text-3xl bg-blue-800 w-100 text-blue-50 text-bold dark:text-white h-36">
				{' '}
			...
			<div className="flex flex-row flex-wrap w-full justify-center md:flex-col p-2">
				<div className="flex flex-none p-4">
				...
				<div className="flex flex-col max-w-lg center text-xl text-gray-500 justify-center p-4">
					...
					<h3 className="text-xxl text-gray-700">
						La mayoría de los emprendedores fracasan en los primeros 5 años{' '}
					</h3>{' '}
				</div>{' '}
			</div>
			<div className="flex p-4 flex-row flex-wrap w-full justify-center md:flex-col">
				...
				<div className="flex flex-none flex-row  p-4">
