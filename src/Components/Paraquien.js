...
function Paraquien() {
  ...
  ¿Es el método High Stratégie para mí?
    ...
    <div className="flex p-8 flex-row flex-wrap md:flex-col w-full justify-center  ">
      <div className="flex flex-none inline-flex ">
        <img className="w-96" src={imgpersona} alt="personas" />
      </div>
    
      <div className="flex flex-col max-w-lg flex-0 center text-xl text-gray-500 justify-center p-8">
    ...
    <div className="flex p-8 flex-row-reverse flex-wrap w-full justify-center md:flex-col">
    <div className="flex flex-none inline-flex">
    ...
    <div className="flex p-8 flex-row flex-wrap w-full justify-center md:flex-col">
...
<h3>La mayoría de los emprendedores fracasan en los primeros 5 años</h3>
      </div>
    ...
    <div className="flex p-8 flex-row flex-wrap w-full justify-center md:flex-col  ">
    <div className="flex flex-none inline-flex">
        <img img className="w-72"src={imggoal} alt="emprendedores" />
      </div>
