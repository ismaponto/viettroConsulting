    ...
    return (
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal  font-manrope text-gray-700 dark:text-gray-400">Desde que trabajo con Matias, no solo mis ventas se duplicaron, mis dias son mas faciles!</p>
