...
<h4 className="mb-2 flex flex-col center justify-center font-manrope w-full text-3xl bg-blue-800 w-100 text-blue-50 text-bold dark:text-white h-36 ">Algunas personas que ya han seguido el curso</h4>
