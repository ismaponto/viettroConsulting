...
const HighStrategy = () => {
  return (
    <div className= "Highstrategy p-8 flex center flex-col">
      ...
      Transforma tus sueños en realidad: Descubre cómo nuestra estrategia alta puede llevar tu negocio al siguiente nivel </p>
      <img className="h-auto max-w-lg-full mx-auto" src={imgHigh} alt="Hig Stratégie Method" />
    </div>
  );
};
