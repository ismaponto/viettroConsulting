...
function Footer() {
    return ( <
        ...
        <
        span className = "text-sm text-gray-500 sm:text-center dark:text-gray-400" > ©2023 < a href = "#Contacto"
        className = "hover:underline" > developed by < /a> Ismael Pontoriero. <
        /span> <
        ...
        <
        a href = "https://www.instagram.com/matiasviettro/"
        className = "hover:underline" >
        <
        img src = { instagramico }
        alt = "Instagram"
        className = "w-8 hover:bg-blue-800" / >
        <
        /a> <
        /li> <
        li className = "flex max-h-2 p-4 " >
        <
        a href = "https://www.linkedin.com/in/matias-viettro-593759271/"
